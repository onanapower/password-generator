...
//   var passwordLength = prompt("Enter a number between 10 and 64 characters:");
// }
// console.log("");
...
//     prompt("Enter a number between 10 and 64 characters")
//   );
...
//     );
//     var includeNumericCharacers = confirm(
//       "would you like to include numeric characters in your password?"
//     );
//     var includeLowercaseCharacers = confirm(
//       "would you like to include lowercase characters in your password?"
//     );
//     var includeUppercaseCharacers = confirm(
//       "would you like to include uppercase characters in your password?"
//     );
//   } else {
//     alert(
//       "Password lenght must be between 10 and 64 characters. Please try again."
//     );
//   }

//   //if statement to go with user input
//   let mixedCharacter = [];
//   if (includeSpecialCharacters) {
//     mixedCharacter = mixedCharacter.concat(specialCharacters);
//   }
//   if (includeNumericCharacers) {
//     mixedCharacter = mixedCharacter.concat(numericCharacters);
//   }
//   if (includeUppercaseCharacers) {
//     mixedCharacter = mixedCharacter.concat(upperCasedCharacters);
//   }
//   if (includeLowercaseCharacers) {
//     mixedCharacter = mixedCharacter.concat(lowerCasedCharacters);
//   }
// }
// console.log(mixedCharacter);

// var password = "";
// for (var i = 0; i < passwordLength.length; i++) {
//   password += getRandom(mixedCharacter);
// }
// return password;
